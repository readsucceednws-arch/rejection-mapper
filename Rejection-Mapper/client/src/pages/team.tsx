...
import { UserPlus, Trash2, Users, KeyRound, Eye, EyeOff, Mail } from "lucide-react";
      ...
      <Dialog open={addOpen} onOpenChange={setAddOpen}>
        <DialogContent className="sm:max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              An invite email will be sent to the worker. They'll click a link to set their own password and activate their account.
            </DialogDescription>
          </DialogHeader>
          <form onSubmit={handleAdd} className="space-y-4 mt-2">
            <div className="space-y-1.5">
              ...
              />
              <p className="text-xs text-muted-foreground">The invite link will be sent here.</p>
            </div>
            <div className="space-y-1.5">
            ...
            <div className="rounded-lg bg-muted/50 border border-border px-3 py-2.5 flex items-start gap-2">
              ...
              <p className="text-xs text-muted-foreground">
                The worker will receive a secure activation link by email. No password is shared in plain text.
              </p>
            </div>
            <Button
              type="submit"
            ...
            >
              {addMutation.isPending ? "Sending invite..." : "Send Invite"}
            </Button>
          </form>
        </DialogContent>
      </Dialog>
