...
import {
  ...
  useUpdateReworkType,
  useDeleteReworkType,
  useBulkDeleteReworkTypes,
} from "@/hooks/use-rework-types";
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 pt-2">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input
                  placeholder="e.g. Surface defect rework"
                  {...field}
                  value={field.value || ""}
        ...
        <div className="flex justify-end gap-2 pt-2">
          ...
          <Button
            type="submit"
            disabled={isPending}
            data-testid="button-submit-rework-type"
          >
...
export default function ManageReworkTypes() {
  ...
  const filtered = (types ?? []).filter(
    (t) =>
      t.reworkCode.toLowerCase().includes(searchTerm.toLowerCase()) ||
  ...
  const handleCreate = (data: FormValues) => {
    createMutation.mutate(data, {
      onSuccess: () => {
        toast({
          title: "Rework Type Created",
          description: "Successfully added new rework type.",
        });
        setIsAddOpen(false);
      },
      onError: (err) =>
  ...
  const handleDelete = () => {
    ...
    deleteMutation.mutate(deleteType.id, {
      onSuccess: () => {
        toast({
          title: "Rework Type Deleted",
          description: `${deleteType.reworkCode} has been removed.`,
        });
        setDeleteType(null);
      },
      onError: (err) =>
  ...
  const handleBulkDelete = () => {
    ...
    bulkDeleteMutation.mutate(ids, {
      onSuccess: () => {
        toast({
          title: "Deleted",
          description: `${ids.length} rework type${
            ids.length !== 1 ? "s" : ""
          } removed.`,
        });
        setSelectedIds(new Set());
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Add and manage rework reason codes
          </p>
        </div>
          ...
          <Dialog open={isAddOpen} onOpenChange={setIsAddOpen}>
            <DialogTrigger asChild>
              <Button
                ...
                data-testid="button-add-rework-type"
              >
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Create a new rework reason code for logging entries.
                </DialogDescription>
              </DialogHeader>
      ...
      <Card className="overflow-hidden border-border/50 shadow-sm">
        <div className="border-b border-border/50 bg-muted/20 p-4">
          <div className="relative w-full max-w-sm">
            ...
            <Input
              placeholder="Search rework types..."
              value={searchTerm}
                ...
                <TableRow>
                  ...
                  >
                    <div className="flex flex-col items-center justify-center text-muted-foreground">
                      ...
                      <p>
                        {searchTerm
                          ? "No rework types match your search."
                          : "No rework types added yet."}
                      </p>
                    </div>
                  </TableCell>
                </TableRow>
                ...
                filtered.map((t) => (
                  <TableRow
                    ...
                    className={`transition-colors hover:bg-muted/30 ${
                      selectedIds.has(t.id) ? "bg-muted/40" : ""
                    }`}
                    ...
                    <TableCell>
                      <div className="flex items-center justify-end gap-1">
                        <Button
                          ...
                          data-testid={`button-edit-rework-type-${t.id}`}
                        >
                        ...
                        <Button
                          ...
                          data-testid={`button-delete-rework-type-${t.id}`}
                        >
      ...
      <Dialog open={!!editType} onOpenChange={(o) => !o && setEditType(null)}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Update the rework type details.
            </DialogDescription>
          </DialogHeader>
          ...
          {editType && (
            <ReworkTypeForm
              defaultValues={{
                reworkCode: editType.reworkCode,
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              <strong>{deleteType?.reworkCode}</strong> and all log entries that
              use this rework type. This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              data-testid="button-confirm-delete-rework-type"
            >
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              You are about to delete <strong>{selectedIds.size}</strong> item
