...
export const insertRejectionEntrySchema = createInsertSchema(rejectionEntries).omit({ id: true, date: true });
export const insertReworkTypeSchema = createInsertSchema(reworkTypes).omit({ id: true });
export const insertReworkEntrySchema = createInsertSchema(reworkEntries).omit({ id: true, date: true });
