...
import { useReworkTypes, useCreateReworkType, useUpdateReworkType, useDeleteReworkType } from "@/hooks/use-rework-types";
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex items-center justify-between">
        ...
        <Dialog open={isAddOpen} onOpenChange={setIsAddOpen}>
          ...
          <DialogContent>
            ...
            <ReworkTypeForm
              defaultValues={{ reworkCode: "", reason: "" }}
          ...
          <Table>
            ...
            <TableBody>
              {isLoading ? (
                ...
                filtered.map((t) => (
                  <TableRow key={t.id} className="hover:bg-muted/30 transition-colors" data-testid={`row-rework-type-${t.id}`}>
      ...
      <Dialog open={!!editType} onOpenChange={(o) => !o && setEditType(null)}>
        <DialogContent>
          ...
          {editType && (
            <ReworkTypeForm
              defaultValues={{ reworkCode: editType.reworkCode, reason: editType.reason || "" }}
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently remove <strong>{deleteType?.reworkCode}</strong>. Existing log entries will not be affected.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
